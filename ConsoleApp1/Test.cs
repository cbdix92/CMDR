...
namespace Test
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            GameObject2 = TestScene.AddGameObject(100, 300, 2);

            TestImage = new CMDR.Image("C:\\Users\\cbdix\\OneDrive\\Desktop\\Test\\bin\\Debug\\Test.bmp");
